...
tmap_save(grade_map, here::here("figs", "holc_grade_map.png"))
```
![](figs/holc_grade_map.png)

We can see the clear distinctions of which areas were deemed a lower safety risk in the red and yellow areas. Green and blue were considered "safer" choices for home loans and other financial support.
...
tm_shape(holc_transform) +
  tm_borders(col = "red") +
  tm_title("Borders for ej_screen data and HOLC data") +
  tm_scalebar(position = tm_pos_in("right", "bottom")) +
  tm_compass(position = tm_pos_in("left", "bottom"))

tmap_save(join_map, here::here("figs", "join_map.png"))
```
![](figs/join_map.png)
...
```
![](figs/census_holc_la.png)
![](figs/census_holc_only.png)
...
ggsave(plot = income_holc_plot, here::here("figs", "income_plot.png"))
```
![](figs/income_plot.png)
...
ggsave(plot = ej_metric_holc_plot, here::here("figs", "metric_holc_plot.png"))
```
![](figs/metric_holc_plot.png)
...
ggsave(plot = bird_holc_plot, here::here("figs", "bird_plot.png"))
```
![](figs/bird_plot.png)
